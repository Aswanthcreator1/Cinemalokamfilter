...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mrtechmoviebot:mrtechmoviebot @cluster0.b27gdqe.mongodb.net/? retryWrites=true&w=majority &appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
